  ...
  return (
    <>
      ...
      <PageBody className="flex flex-col gap-8">
            ...
            {!isLoading && (
              <div className="min-w-[220px]">
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-[13px] font-medium text-gray-950 tabular-nums">
        ...
        {/* Plans */}
        <section>
          <h2 className="mb-3 text-[13px] font-medium text-gray-950">Plans</h2>
        ...
        {/* Invoices */}
        <section>
          <h2 className="mb-3 text-[13px] font-medium text-gray-950">Invoices</h2>
