  ...
  return (
    <>
      ...
      <PageBody className="max-w-4xl mx-auto flex flex-col gap-8">
            ...
            {!isLoading && (
              <div className="min-w-[220px]">
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-[17px] font-medium text-gray-800 tabular-nums">
        ...
        {/* Plans */}
        <section>
          <h2 className="mb-3 text-[17px] font-medium text-gray-800">Plans</h2>
        ...
        {/* Invoices */}
        <section>
          <h2 className="mb-3 text-[17px] font-medium text-gray-800">Invoices</h2>
