  ...
  return (
    <div className="grid max-w-5xl gap-8 lg:grid-cols-[minmax(0,1fr)_300px]">
      <section className="flex flex-col gap-5">
        ...
        <div>
          <h3 className="mb-2 text-[17px] font-medium text-gray-800">Scenarios</h3>
      ...
      <aside className="flex flex-col gap-5">
        <div>
          <h3 className="mb-2 text-[17px] font-medium text-gray-800">Last 7 days</h3>
        ...
        <div>
          <h3 className="mb-2 text-[17px] font-medium text-gray-800">Details</h3>
